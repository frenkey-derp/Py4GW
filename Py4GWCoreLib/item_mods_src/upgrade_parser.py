...
class UpgradeParser:
    ...
    def get_upgrade_property(modifier: DecodedModifier, all_modifiers: list[DecodedModifier], upgrade_type: ItemUpgradeType | None = None, rarity: Rarity = Rarity.Blue) -> Optional[ItemProperty]:
        ...
        upgrade, upgrade_type = UpgradeParser.get_upgrade(modifier, remaining_modifiers, all_modifiers, upgrade_type, rarity)
    ...
    def get_property_factory() -> dict[ModifierIdentifier, Callable[[DecodedModifier, list[DecodedModifier], Rarity], ItemProperty]]:
        return {
            ...
            ModifierIdentifier.Damage: lambda m, mods, rarity: DamageProperty(modifier=m, min_damage=m.arg2, max_damage=m.arg1, damage_type=UpgradeParser.get_damage_type(mods), rarity=rarity),
            ModifierIdentifier.Damage2: lambda m, mods, rarity: DamageProperty(modifier=m, min_damage=m.arg2, max_damage=m.arg1, damage_type=UpgradeParser.get_damage_type(mods), rarity=rarity),
            ...
            ModifierIdentifier.DamagePlusVsSpecies: lambda m, mods, rarity: DamagePlusVsSpecies(modifier=m, damage_increase=m.arg1, species=UpgradeParser.get_species(mods), rarity=rarity),
            ...
            ModifierIdentifier.HalvesCastingTimeItemAttribute: lambda m, mods, rarity: HalvesCastingTimeItemAttribute(modifier=m, chance=m.arg1, attribute=UpgradeParser.get_item_requirement(mods), rarity=rarity),
            ...
            ModifierIdentifier.HalvesSkillRechargeItemAttribute: lambda m, mods, rarity: HalvesSkillRechargeItemAttribute(modifier=m, chance=m.arg1, attribute=UpgradeParser.get_item_requirement(mods), rarity=rarity),
            ...
            ModifierIdentifier.OfTheProfession: lambda m, _, rarity: OfTheProfession(modifier=m, attribute=Attribute(m.arg1), attribute_level=m.arg2, profession=UpgradeParser.get_profession_from_attribute(Attribute(m.arg1)) or Profession._None, rarity=rarity),
            ...
            ModifierIdentifier.AttributeRune: lambda m, mods, rarity:  
                                                                UpgradeParser.get_upgrade_property(m, mods, ItemUpgradeType.Prefix, rarity) or
                                                                UpgradeParser.get_upgrade_property(m, mods, ItemUpgradeType.Inscription, rarity) or
                                                                UpgradeParser.get_upgrade_property(m, mods, ItemUpgradeType.Suffix, rarity) or
                                                                UpgradeParser.get_upgrade_property(m, mods, ItemUpgradeType.UpgradeRune, rarity) or
                                                                UpgradeParser.get_upgrade_property(m, mods, ItemUpgradeType.AppliesToRune, rarity) or

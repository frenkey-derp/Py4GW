...
from .types import ControlAppearance, ImGuiStyleVar, StyleTheme
...
class ImGui:
    ...
    @staticmethod
    def toggle_button_TEXTURED(label: str, v: bool, width=0, height =0, enabled:bool=True) -> bool:
        PyImGui.begin_disabled(not enabled)
        style = ImGui.get_style()
        style.ButtonPadding.get_current().push_style_var()
    ...
    @staticmethod
    def image_toggle_button_TEXTURED(label: str, texture_path: str, v: bool, width=32, height=32, enabled:bool=True) -> bool:
        PyImGui.begin_disabled(not enabled)
        style = ImGui.get_style()
        style.ButtonPadding.push_style_var(width / 8, height / 8)

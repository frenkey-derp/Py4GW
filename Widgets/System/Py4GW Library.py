...
INI_KEY = ""
INI_PATH = "Widgets/Py4GW Library"
INI_FILENAME = "Py4GW Library.ini"
...
def main():
    ...
    if INI_KEY:
        ...
        if use_library:
            ...
            if ImGui.Begin(ini_key=INI_KEY, name=MODULE_NAME, flags=PyImGui.WindowFlags.AlwaysAutoResize):

...
def get_property_factory() -> dict[ModifierIdentifier, Callable[[DecodedModifier, list[DecodedModifier]], ItemProperty]]:
    return {
        ...
        ModifierIdentifier.Damage: lambda m, mods: DamageProperty(modifier=m, min_damage=m.arg2, max_damage=m.arg1, damage_type=get_damage_type(mods)),
        ModifierIdentifier.Damage2: lambda m, mods: DamageProperty(modifier=m, min_damage=m.arg2, max_damage=m.arg1, damage_type=get_damage_type(mods)),

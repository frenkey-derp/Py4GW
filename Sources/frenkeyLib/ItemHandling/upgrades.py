...
class ItemUpgrade(Enum):
    ...
    IHaveThePower = ItemUpgradeClass(upgrade_id = 0x015C,  name = "\"I have the power!\"", upgrade_type = ItemUpgradeClassType.Inscription)
    LetTheMemoryLiveAgain = ItemUpgradeClass(upgrade_id = 0x015E,  name = "\"Let the Memory Live Again!\"", upgrade_type = ItemUpgradeClassType.Inscription)
    TooMuchInformation = ItemUpgradeClass(upgrade_id = 0x0163,  name = "\"Too Much Information\"", upgrade_type = ItemUpgradeClassType.Inscription)
    GuidedByFate = ItemUpgradeClass(upgrade_id = 0x0164,  name = "\"Guided by Fate\"", upgrade_type = ItemUpgradeClassType.Inscription)
    StrengthAndHonor = ItemUpgradeClass(upgrade_id = 0x0165,  name = "\"Strength and Honor\"", upgrade_type = ItemUpgradeClassType.Inscription)
    VengeanceIsMine = ItemUpgradeClass(upgrade_id = 0x0166,  name = "\"Vengeance is Mine\"", upgrade_type = ItemUpgradeClassType.Inscription)
    DontFearTheReaper = ItemUpgradeClass(upgrade_id = 0x0167,  name = "\"Don't Fear the Reaper\"", upgrade_type = ItemUpgradeClassType.Inscription)
    DanceWithDeath = ItemUpgradeClass(upgrade_id = 0x0168,  name = "\"Dance with Death\"", upgrade_type = ItemUpgradeClassType.Inscription)
    BrawnOverBrains = ItemUpgradeClass(upgrade_id = 0x0169,  name = "\"Brawn over Brains\"", upgrade_type = ItemUpgradeClassType.Inscription)
    ToThePain = ItemUpgradeClass(upgrade_id = 0x016A,  name = "\"To The Pain!\"", upgrade_type = ItemUpgradeClassType.Inscription)
    IgnoranceIsBliss = ItemUpgradeClass(upgrade_id = 0x01B6,  name = "\"Ignorance is Bliss\"", upgrade_type = ItemUpgradeClassType.Inscription)
    LifeIsPain = ItemUpgradeClass(upgrade_id = 0x01B7,  name = "\"Life is Pain\"", upgrade_type = ItemUpgradeClassType.Inscription)
    ManForAllSeasons = ItemUpgradeClass(upgrade_id = 0x01B8,  name = "\"Man for All Seasons\"", upgrade_type = ItemUpgradeClassType.Inscription)
    SurvivalOfTheFittest = ItemUpgradeClass(upgrade_id = 0x01B9,  name = "\"Survival of the Fittest\"", upgrade_type = ItemUpgradeClassType.Inscription)
    MightMakesRight = ItemUpgradeClass(upgrade_id = 0x01BA,  name = "\"Might makes Right!\"", upgrade_type = ItemUpgradeClassType.Inscription)
    KnowingIsHalfTheBattle = ItemUpgradeClass(upgrade_id = 0x01BB,  name = "\"Knowing is Half the Battle.\"", upgrade_type = ItemUpgradeClassType.Inscription)
    FaithIsMy = ItemUpgradeClass(upgrade_id = 0x01BC,  name = "\"Faith is My \"", upgrade_type = ItemUpgradeClassType.Inscription)
    DownButNotOut = ItemUpgradeClass(upgrade_id = 0x01BD,  name = "\"Down But Not Out\"", upgrade_type = ItemUpgradeClassType.Inscription)
    HailToTheKing = ItemUpgradeClass(upgrade_id = 0x01BE,  name = "\"Hail to the King\"", upgrade_type = ItemUpgradeClassType.Inscription)
    BeJustAndFearNot = ItemUpgradeClass(upgrade_id = 0x01BF,  name = "\"Be Just and Fear Not\"", upgrade_type = ItemUpgradeClassType.Inscription)
    LiveForToday = ItemUpgradeClass(upgrade_id = 0x01C0,  name = "\"Live for Today\"", upgrade_type = ItemUpgradeClassType.Inscription)
    SerenityNow = ItemUpgradeClass(upgrade_id = 0x01C1,  name = "\"Serenity Now\"", upgrade_type = ItemUpgradeClassType.Inscription)
    ForgetMeNot = ItemUpgradeClass(upgrade_id = 0x01C2,  name = "\"Forget Me Not\"", upgrade_type = ItemUpgradeClassType.Inscription)
    NotTheFace = ItemUpgradeClass(upgrade_id = 0x01C3,  name = "\"Not the face!\"", upgrade_type = ItemUpgradeClassType.Inscription)
    LeafOnTheWind = ItemUpgradeClass(upgrade_id = 0x01C4,  name = "\"Leaf on the Wind\"", upgrade_type = ItemUpgradeClassType.Inscription)
    LikeARollingStone = ItemUpgradeClass(upgrade_id = 0x01C5,  name = "\"Like a Rolling Stone\"", upgrade_type = ItemUpgradeClassType.Inscription)
    RidersOnTheStorm = ItemUpgradeClass(upgrade_id = 0x01C6,  name = "\"Riders on the Storm\"", upgrade_type = ItemUpgradeClassType.Inscription)
    SleepNowInTheFire = ItemUpgradeClass(upgrade_id = 0x01C7,  name = "\"Sleep Now in the Fire\"", upgrade_type = ItemUpgradeClassType.Inscription)
    ThroughThickAndThin = ItemUpgradeClass(upgrade_id = 0x01C8,  name = "\"Through Thick and Thin\"", upgrade_type = ItemUpgradeClassType.Inscription)
    TheRiddleOfSteel = ItemUpgradeClass(upgrade_id = 0x01C9,  name = "\"The Riddle of Steel\"", upgrade_type = ItemUpgradeClassType.Inscription)
    FearCutsDeeper = ItemUpgradeClass(upgrade_id = 0x01CA,  name = "\"Fear Cuts Deeper\"", upgrade_type = ItemUpgradeClassType.Inscription)
    ICanSeeClearlyNow = ItemUpgradeClass(upgrade_id = 0x01CB,  name = "\"I Can See Clearly Now\"", upgrade_type = ItemUpgradeClassType.Inscription)
    SwiftAsTheWind = ItemUpgradeClass(upgrade_id = 0x01CC,  name = "\"Swift as the Wind\"", upgrade_type = ItemUpgradeClassType.Inscription)
    StrengthOfBody = ItemUpgradeClass(upgrade_id = 0x01CD,  name = "\"Strength of Body\"", upgrade_type = ItemUpgradeClassType.Inscription)
    CastOutTheUnclean = ItemUpgradeClass(upgrade_id = 0x01CE,  name = "\"Cast Out the Unclean\"", upgrade_type = ItemUpgradeClassType.Inscription)
    PureOfHeart = ItemUpgradeClass(upgrade_id = 0x01CF,  name = "\"Pure of Heart\"", upgrade_type = ItemUpgradeClassType.Inscription)
    SoundnessOfMind = ItemUpgradeClass(upgrade_id = 0x01D0,  name = "\"Soundness of Mind\"", upgrade_type = ItemUpgradeClassType.Inscription)
    OnlyTheStrongSurvive = ItemUpgradeClass(upgrade_id = 0x01D1,  name = "\"Only the Strong Survive\"", upgrade_type = ItemUpgradeClassType.Inscription)
    LuckOfTheDraw = ItemUpgradeClass(upgrade_id = 0x01D2,  name = "\"Luck of the Draw\"", upgrade_type = ItemUpgradeClassType.Inscription)
    ShelteredByFaith = ItemUpgradeClass(upgrade_id = 0x01D3,  name = "\"Sheltered by Faith\"", upgrade_type = ItemUpgradeClassType.Inscription)
    NothingToFear = ItemUpgradeClass(upgrade_id = 0x01D4,  name = "\"Nothing to Fear\"", upgrade_type = ItemUpgradeClassType.Inscription)
    RunForYourLife = ItemUpgradeClass(upgrade_id = 0x01D5,  name = "\"Run For Your Life!\"", upgrade_type = ItemUpgradeClassType.Inscription)
    MasterOfMyDomain = ItemUpgradeClass(upgrade_id = 0x01D6,  name = "\"Master of My Domain\"", upgrade_type = ItemUpgradeClassType.Inscription)
    AptitudeNotAttitude = ItemUpgradeClass(upgrade_id = 0x01D7,  name = "\"Aptitude not Attitude\"", upgrade_type = ItemUpgradeClassType.Inscription)
    SeizeTheDay = ItemUpgradeClass(upgrade_id = 0x01D8,  name = "\"Seize the Day\"", upgrade_type = ItemUpgradeClassType.Inscription)
    HaveFaith = ItemUpgradeClass(upgrade_id = 0x01D9,  name = "\"Have Faith\"", upgrade_type = ItemUpgradeClassType.Inscription)
    HaleAndHearty = ItemUpgradeClass(upgrade_id = 0x01DA,  name = "\"Hale and Hearty\"", upgrade_type = ItemUpgradeClassType.Inscription)
    DontCallItAComeback = ItemUpgradeClass(upgrade_id = 0x01DB,  name = "\"Don't call it a comeback!\"", upgrade_type = ItemUpgradeClassType.Inscription)
    IAmSorrow = ItemUpgradeClass(upgrade_id = 0x01DC,  name = "\"I am Sorrow.\"", upgrade_type = ItemUpgradeClassType.Inscription)
    DontThinkTwice = ItemUpgradeClass(upgrade_id = 0x01DD,  name = "\"Don't Think Twice\"", upgrade_type = ItemUpgradeClassType.Inscription)
    ShowMeTheMoney = ItemUpgradeClass(upgrade_id = 0x021E,  name = "\"Show me the money\"", upgrade_type = ItemUpgradeClassType.Inscription)
    MeasureForMeasure = ItemUpgradeClass(upgrade_id = 0x021F,  name = "\"Measure for Measure\"", upgrade_type = ItemUpgradeClassType.Inscription)

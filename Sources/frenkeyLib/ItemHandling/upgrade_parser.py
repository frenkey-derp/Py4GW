...
from Sources.frenkeyLib.ItemHandling.properties import *
from Sources.frenkeyLib.ItemHandling.types import ItemBaneSpecies, ItemUpgradeType, ModifierIdentifier
from Sources.frenkeyLib.ItemHandling.upgrades import Upgrade, UnknownUpgrade, _UPGRADES
...
_PROPERTY_FACTORY: dict[ModifierIdentifier, Callable[[DecodedModifier, list[DecodedModifier]], ItemProperty]] = {
    ...
    ModifierIdentifier.OfTheProfession: lambda m, _: OfTheProfessionProperty(modifier=m, attribute=Attribute(m.arg1), attribute_level=m.arg2, profession=get_profession_from_attribute(Attribute(m.arg1)) or Profession._None),

...
from Sources.frenkey.LootEx.enum import ModType, ModifierIdentifier
from Sources.frenkey.LootEx.models import ItemModifiersInformation, RuneModInfo, WeaponModInfo

class Cached_Item:
    def __init__(self, item_id: int, slot: int = -1):
        from Sources.frenkey.LootEx import utility, models, enum, skin_rule, weapon_rule
    ...
    def GetModsFromModifiers(self) -> tuple[list[RuneModInfo], list[WeaponModInfo]]:
        from Sources.frenkey.LootEx.enum import ModifierIdentifier

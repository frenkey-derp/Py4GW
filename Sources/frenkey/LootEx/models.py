...
from Sources.frenkey.Core.utility import get_image_name
from Sources.frenkey.LootEx import enum
from Sources.frenkey.LootEx.enum import INVALID_NAMES, Campaign, EnemyType, MaterialType, ModType, ModifierIdentifier, ModifierValueArg, ModsModels
...
def get_server_language() -> ServerLanguage:
    from Sources.frenkey.LootEx import settings
...
class WeaponModInfo(BaseModInfo):       
    ...
    def get_from_modifiers(modifiers: list[tuple[int, int, int]], item_type: ItemType = ItemType.Unknown, model_id: int = -1) -> list["WeaponModInfo"] | None:
        ...
        for weapon_mod in potential_weapon_mods:
            ...
            from Sources.frenkey.LootEx import utility
...
class ItemModifiersInformation:
    def __init__(self):
        from Sources.frenkey.LootEx.models import WeaponModInfo, RuneModInfo        
    ...
    def populate_from_modifiers(self, modifiers: list[ItemModifier], item_type: ItemType, model_id: int, is_inscribable: bool) -> "ItemModifiersInformation":
        from Sources.frenkey.LootEx.models import WeaponModInfo

...
from Sources.frenkey.LootEx import messaging, ui_manager_extensions, utility
from Sources.frenkey.LootEx.cache import Cached_Item
from Sources.frenkey.LootEx.enum import ALL_BAGS, ITEM_TEXTURE_FOLDER, ModType
from Sources.frenkey.LootEx.models import Item, ItemModifiersInformation, ItemsByType, WeaponMod
...
class CollectionEntry(Item):
    ...
    def get_cleaned_item_name(self, item_name : str, server_language: ServerLanguage) -> str:  
        ...
        from Sources.frenkey.LootEx.models import RuneModInfo, WeaponModInfo

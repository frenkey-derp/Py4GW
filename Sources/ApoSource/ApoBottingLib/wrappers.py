...
def CreateParty(
    ...
    if hero_ids:
        children.append(RoutinesBT.Party.Heroes.SetupHeroes(heroes=hero_ids))
    if henchman_ids:
        children.append(RoutinesBT.Party.Henchmen.SetupHenchmen(henchmen=henchman_ids))
...
def SetupParty(
    ...
    return RoutinesBT.Party.SetupParty(
        henchmen=henchmen,
        heroes=heroes,
        players=players,
        account_heroes=account_heroes,
        require_outpost=require_outpost,
        leave_if_no_leader=leave_if_no_leader,
        timeout_ms=timeout_ms,
        poll_interval_ms=poll_interval_ms,
        aftercast_ms=aftercast_ms,
        log=log,
